...
return [
    ...
    'route'         => [
        ...
        'attributes' => [
            'prefix'     => 'dashboard/administratives/statistics',
    ...
    'icons' =>  [
         ...
         */
        'all'       => 'fas fa-fw fa-list',                 // http://fontawesome.io/icon/list/
        ...
        'error'     => 'fas fa-fw fa-times-circle',         // http://fontawesome.io/icon/times-circle/
