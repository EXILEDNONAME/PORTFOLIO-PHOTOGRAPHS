...
<html lang="en">
  ...
  <head>
    ...
    <!-- Apple Touch Icon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ env('APP_URL') }}/assets/frontend/demo-3/img/apple-touch-icon.png">

    <!-- Favicon -->
    <link rel="icon" href="{{ env('APP_URL') }}/assets/frontend/demo-3/img/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ env('APP_URL') }}/assets/frontend/demo-3/img/favicon.png" type="image/x-icon">

    <!-- Theme Settings Js -->
    <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/theme-script.js"></script>

    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/css/animate.css">
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/css/bootstrap.min.css">

    <!-- Main.css -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/css/meanmenu.css">

    <!-- Tabler Icon CSS -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/tabler-icons/tabler-icons.css">

    <!-- Fontawesome Icon CSS -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/fontawesome/css/fontawesome.min.css">
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/fontawesome/css/all.min.css">

    <!-- Fancybox CSS -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/fancybox/jquery.fancybox.min.css">

    <!-- Owlcarousel CSS -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/owlcarousel/owl.carousel.min.css">

    <!-- Iconsax CSS -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/css/iconsax.css">

    <!-- Datepicker CSS -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/css/bootstrap-datetimepicker.min.css">

    <!-- Style CSS -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/frontend/demo-3/css/style.css">
  ...
  <body>
        ...
        <div class="container">
          <div class="d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="d-flex align-items-center">
              <p class="mb-2 me-3 d-flex align-items-center fw-medium fs-14"><i class="isax isax-message-text-15 me-2"></i>Email : <a href="../cdn-cgi/l/email-protection.htm" class="__cf_email__" data-cfemail="533a3d353c13362b323e233f367d303c3e">[email&#160;protected]</a></p>
              <div class="dropdown flag-dropdown mb-2 me-3">
                <a href="javascript:void(0);" class="dropdown-toggle d-inline-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false">
                  <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/us-flag.svg" class="me-2" alt="flag">ENG
                </a>
                <ul class="dropdown-menu p-2 mt-2">
                  ...
                  <li>
                    <a class="dropdown-item rounded d-flex align-items-center" href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/arab-flag.svg" class="me-2" alt="flag">ARA
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item rounded d-flex align-items-center" href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/france-flag.svg" class="me-2" alt="flag">FRE
                    </a>
                  </li>
                </ul>
              </div>
                ...
                <div class="offcanvas-head">
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    <a href="index.html" class="black-logo-responsive">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/logo-dark.svg" alt="logo-img">
                    </a>
                    <a href="index.html" class="white-logo-responsive">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/logo.svg" alt="logo-img">
                    </a>
            ...
            <div class="main-menu-wrapper">
              <div class="navbar-logo">
                <a class="logo-white header-logo" href="index.html">
                  <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/logo.svg" class="logo" alt="Logo">
                </a>
                <a class="logo-dark header-logo" href="index.html">
                  <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/logo-dark.svg" class="logo" alt="Logo">
                </a>
              </div>
              <nav id="mobile-menu">
                <ul class="main-nav">
                          ...
                          <div class="row g-lg-4">
                            <div class="col-lg-2">
                              <div class="single-demo active">
                                <div class="demo-img">
                                  <a href="index.html"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/home-01.jpg" class="img-fluid" alt="img"></a>
                                </div>
                                <div class="demo-info">
                            ...
                            <div class="col-lg-2">
                              <div class="single-demo">
                                <div class="demo-img">
                                  <a href="index-2.html"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/home-02.jpg" class="img-fluid" alt="img"></a>
                                </div>
                                <div class="demo-info">
                            ...
                            <div class="col-lg-2">
                              <div class="single-demo">
                                <div class="demo-img">
                                  <a href="index-3.html"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/home-03.jpg" class="img-fluid" alt="img"></a>
                                </div>
                                <div class="demo-info">
                            ...
                            <div class="col-lg-2">
                              <div class="single-demo">
                                <div class="demo-img">
                                  <a href="index-4.html"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/home-04.jpg" class="img-fluid" alt="img"></a>
                                </div>
                                <div class="demo-info">
                            ...
                            <div class="col-lg-2">
                              <div class="single-demo">
                                <div class="demo-img">
                                  <a href="index-5.html"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/home-05.jpg" class="img-fluid" alt="img"></a>
                                </div>
                                <div class="demo-info">
                            ...
                            <div class="col-lg-2">
                              <div class="single-demo">
                                <div class="demo-img">
                                  <a href="index-6.html"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/home-06.jpg" class="img-fluid" alt="img"></a>
                                </div>
                                <div class="demo-info">
                      ...
                      <li>
                        <div class="megamenu-wrapper">
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="menu-img">
                                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/flight.jpg" alt="img" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <li>
                        <div class="megamenu-wrapper">
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="menu-img">
                                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/hotel.jpg" alt="img" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <li>
                        <div class="megamenu-wrapper">
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="menu-img">
                                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/car.jpg" alt="img" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <li>
                        <div class="megamenu-wrapper">
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="menu-img">
                                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/cruise.jpg" alt="img" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <li>
                        <div class="megamenu-wrapper">
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="menu-img">
                                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/menu/tour.jpg" alt="img" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="header-btn d-flex align-items-center">
                ...
                <a href="become-an-expert.html" class="btn btn-primary me-0">Become Expert</a>
    ...
    <section class="hero-section">
      <div class="banner-slider banner-sec owl-carousel">
        <div class="slider-img">
          <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/banner/banner-01.jpg" alt="Img">
        </div>
        <div class="slider-img">
          <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/banner/banner-02.jpg" alt="Img">
        </div>
        <div class="slider-img">
          <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/banner/banner-03.jpg" alt="Img">
        </div>
        <div class="slider-img">
          <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/banner/banner-04.jpg" alt="Img">
        </div>
      </div>
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="owl-carousel destination-slider nav-center">
          ...
          <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/destination/destination-01.jpg" alt="img">
          ...
          <!-- Destination Item-->
          <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/destination/destination-02.jpg" alt="img">
            <div class="destination-info text-center">
              <div class="destination-content">
          ...
          <!-- Destination Item-->
          <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/destination/destination-03.jpg" alt="img">
            <div class="destination-info text-center">
              <div class="destination-content">
          ...
          <!-- Destination Item-->
          <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/destination/destination-04.jpg" alt="img">
            <div class="destination-info text-center">
              <div class="destination-content">
          ...
          <!-- Destination Item-->
          <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/destination/destination-05.jpg" alt="img">
            <div class="destination-info text-center">
              <div class="destination-content">
                  ...
                  <div class="img-slider image-slide owl-carousel nav-center">
                    <div class="slide-images">
                      <a href="hotel-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/hotels/hotel-01.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="hotel-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/hotels/hotel-02.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="hotel-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/hotels/hotel-03.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <a href="javascript:void(0);" class="d-flex align-items-center">
                      <span class="avatar avatar-md me-2">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-01.jpg" class="rounded-circle" alt="img">
                      </span>
              ...
              <div class="place-item mb-4">
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <a href="javascript:void(0);" class="d-flex align-items-center">
                      <span class="avatar avatar-md me-2">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-06.jpg" class="rounded-circle" alt="img">
                      </span>
              ...
              <div class="place-item mb-4">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="hotel-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/hotels/hotel-04.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="hotel-details.html">
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <a href="javascript:void(0);" class="d-flex align-items-center">
                      <span class="avatar avatar-md me-2">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-02.jpg" class="rounded-circle" alt="img">
                      </span>
              ...
              <div class="place-item mb-4">
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <a href="javascript:void(0);" class="d-flex align-items-center">
                      <span class="avatar avatar-md me-2">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-04.jpg" class="rounded-circle" alt="img">
                      </span>
          ...
          <div class="tab-pane fade" id="flight-list">
            <div class="owl-carousel place-slider nav-center">
              ...
              <div class="place-item mb-4">
                <div class="place-img">
                  <a href="flight-details.html">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-01.jpg" class="img-fluid" alt="img">
                  </a>
                  <div class="fav-item">
                    <div class="d-flex align-items-center">
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center mb-2">
                    <span class="avatar avatar-sm me-2">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/airindia.svg" class="rounded-circle" alt="icon">
                    </span>
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <a href="javascript:void(0);" class="avatar avatar-sm">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-11.jpg" class="rounded-circle" alt="img">
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="place-item mb-4">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    <div class="slide-images">
                      <a href="flight-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-02.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="flight-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-06.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="flight-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-07.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <a href="javascript:void(0);" class="avatar avatar-sm">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-12.jpg" class="rounded-circle" alt="img">
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="place-item mb-4">
                <div class="place-img">
                  <a href="flight-details.html">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-03.jpg" class="img-fluid" alt="img">
                  </a>
                  <div class="fav-item">
                    <div class="d-flex align-items-center">
                      <a href="javascript:void(0);" class="fav-icon me-2">
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <a href="javascript:void(0);" class="avatar avatar-sm">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-13.jpg" class="rounded-circle" alt="img">
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="place-item mb-4">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    <div class="slide-images">
                      <a href="flight-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-04.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="flight-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-08.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="flight-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flight/flight-10.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <a href="javascript:void(0);" class="avatar avatar-sm">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-15.jpg" class="rounded-circle" alt="img">
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="place-content">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-top pt-3">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <a href="javascript:void(0);" class="avatar avatar-sm">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-10.jpg" class="rounded-circle" alt="img">
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="place-item mb-4 flex-fill">
                  ...
                  <div class="img-slider image-slide owl-carousel nav-center">
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-06.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-07.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-08.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
                ...
                <div class="place-content">
                  <a href="javascript:void(0);" class="avatar avatar-md ms-3 car-avatar-image">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-08.jpg" class="rounded-circle" alt="img">
                  </a>
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-09.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
                ...
                <div class="place-content">
                  <a href="javascript:void(0);" class="avatar avatar-md ms-3 car-avatar-image">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-09.jpg" class="rounded-circle" alt="img">
                  </a>
                  <div class="d-flex align-items-center justify-content-between mb-1">
                    <div class="d-flex flex-wrap align-items-center">
                      <span class="badge badge-secondary  fs-10 fw-medium me-1">Sedan</span>
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-10.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-11.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-12.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="car-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cars/car-13.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
          ...
          <div class="tab-pane fade" id="Cruise-list">
            <div class="owl-carousel place-slider nav-center">
                  ...
                  <div class="img-slider image-slide owl-carousel nav-center">
                    <div class="slide-images">
                      <a href="cruise-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-05.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="cruise-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-02.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="cruise-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-04.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <a href="cruise-details.html">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-12.jpg" class="img-fluid" alt="img">
                  </a>
                  <div class="fav-item">
                    <a href="javascript:void(0);" class="fav-icon">
                      <i class="isax isax-heart5"></i>
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <a href="cruise-details.html">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-09.jpg" class="img-fluid" alt="img">
                  </a>
                  <div class="fav-item">
                    <a href="javascript:void(0);" class="fav-icon">
                      <i class="isax isax-heart5"></i>
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <a href="cruise-details.html">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-10.jpg" class="img-fluid" alt="img">
                  </a>
                  <div class="fav-item">
                    <a href="javascript:void(0);" class="fav-icon">
                      <i class="isax isax-heart5"></i>
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    <div class="slide-images">
                      <a href="cruise-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-01.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="cruise-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/cruise/cruise-07.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="cruise-details.html">
                  ...
                  <div class="img-slider image-slide owl-carousel nav-center">
                    <div class="slide-images">
                      <a href="tour-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/tours/tours-07.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="tour-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/tours/tours-08.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                    <div class="slide-images">
                      <a href="tour-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/tours/tours-09.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="tour-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/tours/tours-10.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="tour-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/tours/tours-11.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="tour-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/tours/tours-12.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
              ...
              <div class="place-item mb-4 flex-fill">
                <div class="place-img">
                  <div class="img-slider image-slide owl-carousel nav-center">
                    ...
                    <div class="slide-images">
                      <a href="tour-details.html">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/tours/tours-13.jpg" class="img-fluid" alt="img">
                      </a>
                    </div>
                  </div>
                  <div class="fav-item">
    ...
    <section class="section about-section">
      <div class="container">
            ...
            <div class="about-image mb-4 mb-lg-0">
              <div class="about-listing">
                ...
                <div class="listing-img">
                  <div>
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/listing.svg" alt="icon">
                  </div>
                  <a href="add-hotel.html" class="btn btn-warning text-gray-9">Add You Listings</a>
                </div>
              </div>
              <div class="about-img">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/about.png" alt="about">
              </div>
              <div class="about-progress d-inline-flex align-items-center">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/progress-icon.svg" alt="icon">
                <div class="ms-2">
            ...
            <div class="d-flex align-items-center flex-wrap about-btn gap-2">
              ...
              <div class="avatar-list-stacked avatar-group-md me-2">
                <span class="avatar avatar-rounded">
                  <img class="border border-white" src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-01.jpg" alt="img">
                </span>
                <span class="avatar avatar-rounded">
                  <img class="border border-white" src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-04.jpg" alt="img">
                </span>
                <span class="avatar avatar-rounded">
                  <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-05.jpg" alt="img">
                </span>
                <span class="avatar avatar-rounded">
                  <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-06.jpg" alt="img">
                </span>
              </div>
              <div>
                <div class="d-flex align-items-center">
        ...
        <div class="about-bg">
          <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/bg/about-bg.png" alt="img" class="about-bg-01">
          <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/bg/about-bg-01.svg" alt="img" class="about-bg-02">
        </div>
      </div>
    </section>
    <!-- /About Section -->
      ...
      <div class="container">
        ...
        <div class="owl-carousel experts-slider nav-center">
          ...
          <div class="expert-item mb-4">
            <a href="javascript:void(0);" class="expert-img">
              <div class="bg-purple-100 position-relative">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/expert/expert-01.png" alt="img">
            ...
            <div class="expert-content">
              ...
              <p class="d-flex align-items-center"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/brazil.svg" alt="img" class="me-2">Brazil, Rio</p>
          ...
          <div class="expert-item mb-4">
            <a href="javascript:void(0);" class="expert-img">
              <div class="bg-orange-100 position-relative">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/expert/expert-02.png" alt="img">
            ...
            <div class="expert-content">
              ...
              <p class="d-flex align-items-center"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/japan.svg" alt="img" class="me-2">Tokyo, Japan</p>
              <div class="d-flex border-top mt-3 pt-3">
                <div class="flex-fill">
                  <p class="mb-1">Total Listings</p>
                  <h6>21</h6>
          ...
          <div class="expert-item mb-4">
            <a href="javascript:void(0);" class="expert-img">
              <div class="bg-pink-100 position-relative">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/expert/expert-03.png" alt="img">
            ...
            <div class="expert-content">
              ...
              <p class="d-flex align-items-center"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/africa.svg" alt="img" class="me-2">Cape Town, South Africa</p>
              <div class="d-flex border-top mt-3 pt-3">
                <div class="flex-fill">
                  <p class="mb-1">Total Listings</p>
                  <h6>15</h6>
          ...
          <div class="expert-item mb-4">
            <a href="javascript:void(0);" class="expert-img">
              <div class="bg-teal-100 position-relative">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/expert/expert-04.png" alt="img">
            ...
            <div class="expert-content">
              ...
              <h5 class="mb-1"><a href="javascript:void(0);">Damien Martien</a></h5>
              <p class="d-flex align-items-center"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/australia.svg" alt="img" class="me-2">Sydney, Australia</p>
              <div class="d-flex border-top mt-3 pt-3">
                <div class="flex-fill">
                  <p class="mb-1">Total Listings</p>
                  <h6>15</h6>
          ...
          <div class="expert-item mb-4">
            <a href="javascript:void(0);" class="expert-img">
              <div class="bg-purple-100 position-relative">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/expert/expert-05.png" alt="img">
            ...
            <div class="expert-content">
              ...
              <p class="d-flex align-items-center"><img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/flags/norway.svg" alt="img" class="me-2">Oslo, Norway</p>
              <div class="d-flex border-top mt-3 pt-3">
                <div class="flex-fill">
                  <p class="mb-1">Total Listings</p>
                  <h6>17</h6>
      ...
      <div class="container">
        ...
        <div class="owl-carousel client-slider">
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-01.svg" alt="img">
          </div>
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-02.svg" alt="img">
          </div>
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-03.svg" alt="img">
          </div>
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-04.svg" alt="img">
          </div>
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-05.svg" alt="img">
          </div>
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-06.svg" alt="img">
          </div>
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-07.svg" alt="img">
          </div>
          <div class="client-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/clients/client-04.svg" alt="img">
          </div>
    ...
    <section class="section testimonial-section">
          ...
          <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
            <div class="card-body">
              ...
              <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <a href="javascript:void(0);" class="avatar avatar-md  flex-shrink-0">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-03.jpg" class="rounded-circle" alt="img">
                  </a>
                  <div class="ms-2">
              ...
              <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <span class="avatar avatar-md  flex-shrink-0">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-05.jpg" class="rounded-circle" alt="img">
                  </span>
                  <div class="ms-2">
      ...
      <div class="testimonial-bg">
        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/bg/testimonial-bg-01.svg" alt="img">
      </div>
    </section>
    <!-- /Testimonial Section -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="update-sec">
              ...
              <div class="update-bg">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/bg/update-bg.png" alt="img">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
              <a href="blog-details.html" class="blog-img">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/blog/blog-01.jpg" alt="img">
              </a>
                  ...
                  <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                    <a href="javascript:void(0);" class="d-flex align-items-center">
                      <span class="avatar avatar-sm flex-shrink-0 me-2">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-01.jpg" class="rounded-circle border border-white" alt="img">
                      </span>
                      <p>Bryan Bradfield</p>
                    </a>
                  </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
              <a href="blog-details.html" class="blog-img">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/blog/blog-02.jpg" alt="img">
              </a>
              ...
              <div class="blog-info text-center">
                <div class="d-inline-flex align-items-center justify-content-center">
                  <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                    <a href="javascript:void(0);" class="d-flex align-items-center">
                      <span class="avatar avatar-sm flex-shrink-0 me-2">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-02.jpg" class="rounded-circle border border-white" alt="img">
                      </span>
                      <p>Michell West</p>
                    </a>
                  </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
              <a href="blog-details.html" class="blog-img">
                <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/blog/blog-03.jpg" alt="img">
              </a>
              ...
              <div class="blog-info text-center">
                <div class="d-inline-flex align-items-center justify-content-center">
                  <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                    <a href="javascript:void(0);" class="d-flex align-items-center">
                      <span class="avatar avatar-sm flex-shrink-0 me-2">
                        <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/users/user-03.jpg" class="rounded-circle border border-white" alt="img">
                      </span>
                      <p>Patricia Hasbro</p>
                    </a>
                  </div>
      ...
      <div class="container">
        <div class="footer-top">
              ...
              <div class="col-lg-6 col-xl-3 col-xxl-3">
                <div class="mb-3 text-center text-xl-start">
                  <a href="index.html" class="d-block footer-logo-light">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/logo-dark.svg" alt="logo">
                  </a>
                  <a href="index.html" class="footer-logo-dark">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/logo.svg" alt="logo">
                  </a>
                </div>
              </div>
              <div class="col-lg-6 col-xl-4 col-xxl-4">
                <div class="d-flex align-items-center justify-content-center flex-wrap">
                  ...
                  <a href="javascript:void(0);" class="d-block mb-3 me-2">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/googleplay.svg" alt="logo">
                  </a>
                  <a href="javascript:void(0);" class="d-block mb-3">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/appstore.svg" alt="logo">
                  </a>
                </div>
              </div>
                ...
                <div class="d-sm-flex align-items-center justify-content-center justify-content-xl-end">
                  ...
                  <div class="d-flex align-items-center justify-content-center justify-content-sm-start mb-3">
                    ...
                    <div class="ms-2">
                      ...
                      <p class="fw-medium text-dark"><a href="../cdn-cgi/l/email-protection.htm" class="__cf_email__" data-cfemail="4c25222a230c29342d213c2029622f2321">[email&#160;protected]</a></p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="footer-img">
            <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/bg/footer.svg" class="img-fluid" alt="img">
          </div>
        </div>
      </div>
      <!-- Footer Bottom -->
                ...
                <ul class="card-links">
                  <li>
                    <a href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/card-01.svg" alt="img">
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/card-02.svg" alt="img">
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/card-03.svg" alt="img">
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/card-04.svg" alt="img">
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/card-05.svg" alt="img">
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0);">
                      <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/card-06.svg" alt="img">
                    </a>
                  </li>
                </ul>
              </div>
              ...
              <form action="index.html">
                ...
                <div class="d-flex align-items-center mb-3">
                  <a href="javascript:void(0);" class="btn btn-light flex-fill d-flex align-items-center justify-content-center me-2">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/google-icon.svg" class="me-2" alt="Img">Google
                  </a>
                  <a href="javascript:void(0);" class="btn btn-light flex-fill d-flex align-items-center justify-content-center">
                    <img src="{{ env('APP_URL') }}/assets/frontend/demo-3/img/icons/fb-icon.svg" class="me-2" alt="Img">Facebook
                  </a>
                </div>
        ...
        <div class="modal fade" id="change-password">
          ...
          <div class="modal fade" id="forgot-modal">
            ...
            <div class="back-to-top">
              <a class="back-to-top-icon align-items-center justify-content-center d-flex"  href="index.html#top"><i class="fa-solid fa-arrow-up"></i></a>
            </div>

            <!-- Jquery JS -->
            <script data-cfasync="false" src="{{ env('APP_URL') }}/assets/frontend/demo-3/email-decode.min.js"></script>
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/jquery-3.7.1.min.js"></script>

            <!-- Bootstrap JS -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/bootstrap.bundle.min.js"></script>

            <!-- Wow JS -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/wow.min.js"></script>

            <!-- MeanMenu Js -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/jquery.meanmenu.min.js"></script>

            <!-- Swiper Js -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/owlcarousel/owl.carousel.min.js"></script>

            <!-- Fancybox JS -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/fancybox/jquery.fancybox.min.js"></script>

            <!-- Counter JS -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/jquery.counterup.min.js"></script>
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/jquery.waypoints.min.js"></script>

            <!-- Datepicker Core JS -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/plugins/moment/moment.js"></script>
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/bootstrap-datetimepicker.min.js"></script>

            <!-- cursor JS -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/cursor.js"></script>

            <!-- Script JS -->
            <script src="{{ env('APP_URL') }}/assets/frontend/demo-3/js/script.js"></script>
